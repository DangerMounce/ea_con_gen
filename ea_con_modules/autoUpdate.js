// This module handles all the functions relating to automatically updating when the main branch has updated
...
const branchName = 'Version17' // 'main'
...
const updateDir = path.resolve(__dirname, '..');  //`autoUpdate.js` is in the `modules` directory
